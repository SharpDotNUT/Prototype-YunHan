export const ExampleTextGI = {
  ...
  ja: [
    '「美しき雲に愛しき花、風流は山水にあり。川面に映る半月は美しき顔、細き眉と蒼き酒に心掴まれる」。',
    'GI_ja-JP'
  ]
};
export const ExampleTextHSR = {
  'zh-Hans': [
    '手工雕琢的银戒，附耳能够听到雪融的声音。\n' +
  ...
  ja: [
    '手作りの銀の指輪。耳を当てると雪解けの音が聞こえるようだ。\n' +
      'エイジリアでは、死者が旅立つ前に氷雪を指輪に封じ、生者に贈る習慣がある。残った者に道を示すためだそうだ。\n' +
      '「雪が解け、花が咲く時、あなたは私を見つけられるでしょう」',
    'HSR_ja-JP'
  ]
};
export const ExampleTextZZZ = {
  'zh-Hans': [
  ...
  en: [
    'Faction: Hollow Special Operations Section 6; Height: 170 (Ears Included)\n' +
      'The more she battles, the more it becomes evident to outsiders:\n' +
      'If there is a god of swordsmanship, it must greatly favor Hoshimi Miyabi.',
    'ZZZ_en-US'
  ],
  ja: [
    '対ホロウ特別行動部第六課；身長：170（耳を含む）\n' +
      '幾度にもわたる戦いの果てに、人々は確信を持つようになった——\n' +
      'もしこの世に刀剣の神が存在するのなら、それは星見雅を寵愛しているに違いない、と。',
    'ZZZ_ja-JP'
  ]
};
